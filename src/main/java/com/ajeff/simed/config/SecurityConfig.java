	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				...
				.antMatchers("/satisfacao/pergunta/novo").hasRole("SATISFACAO_PERGUNTA_CADASTRAR")
				.antMatchers("/satisfacao/pergunta/pesquisar").hasRole("SATISFACAO_PERGUNTA_PESQUISAR")
				.antMatchers("/satisfacao/pergunta/excluir/**").hasRole("SATISFACAO_PERGUNTA_EXCLUIR")
				.antMatchers("/satisfacao/pergunta/alterar/**").hasRole("SATISFACAO_PERGUNTA_ALTERAR")
				.antMatchers("/satisfacao/resposta/novo").hasRole("SATISFACAO_RESPOSTA_CADASTRAR")
				.antMatchers("/satisfacao/resposta/pesquisar").hasRole("SATISFACAO_RESPOSTA_PESQUISAR")
				.antMatchers("/satisfacao/resposta/excluir/**").hasRole("SATISFACAO_RESPOSTA_EXCLUIR")
				.antMatchers("/satisfacao/resposta/alterar/**").hasRole("SATISFACAO_RESPOSTA_ALTERAR")
				.antMatchers("/satisfacao/questionario/nova").hasRole("SATISFACAO_QUESTIONARIO_CADASTRAR")
				.antMatchers("/satisfacao/questionario/pesquisar").hasRole("SATISFACAO_QUESTIONARIO_PESQUISAR")
				.antMatchers("/satisfacao/questionario/excluir/**").hasRole("SATISFACAO_QUESTIONARIO_EXCLUIR")
				.antMatchers("/satisfacao/questionario/alterar/**").hasRole("SATISFACAO_QUESTIONARIO_ALTERAR")
				.antMatchers("/satisfacao/pesquisa/inicio").hasRole("SATISFACAO_PESQUISA_CADASTRAR")
				.antMatchers("/satisfacao/pesquisa/fim").hasRole("SATISFACAO_PESQUISA_CADASTRAR")
				.antMatchers("/satisfacao/pesquisa/itens").hasRole("SATISFACAO_PESQUISA_CADASTRAR")
